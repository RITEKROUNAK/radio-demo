...
class NowPlayingViewController: UIViewController {
    ...
    @IBAction func favButton(_ sender: UIButton) {
        ...
        if UserDefaults.standard.bool(forKey: "purchased") {
            ...
            let favStation = Stations(context: context)
            favStation.name = currentStation.name
            favStation.desc = currentStation.desc
            favStation.longDesc = currentStation.longDesc
            favStation.imageURL = currentStation.imageURL
            favStation.streamURL = currentStation.streamURL
    ...
    @IBAction func shareButtonPressed(_ sender: UIButton) {
        ...
        let radioShoutout = "I'm listening to \(currentStation.name) via Simple Radio - https://itunes.apple.com/app/id1518812350"
...
extension NowPlayingViewController {
    ...
    private func showMessage(_ message: String) {
        ...
        label.frame.size = CGSize(width: label.frame.width + 100, height: 50)
